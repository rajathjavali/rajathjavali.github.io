...
class ShiftChart {
     ...
     */
    constructor(electionWinners, allData){
        ...
        this.divvotesPercentage = d3.select("#shiftviz").attr("style", "width: 100%");
